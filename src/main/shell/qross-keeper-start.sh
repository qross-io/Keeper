...
then
    ...
    #`date +%F`.log
    /srv/jdk1.8/bin/java -cp /home/panda/qross-keeper-0.5.7.jar io.qross.keeper.Protector
else
    echo "qross keeper is running....."
    /srv/jdk1.8/bin/java -cp /home/panda/qross-keeper-0.5.7.jar io.qross.keeper.Notifier
fi