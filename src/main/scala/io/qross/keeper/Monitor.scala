...
class Monitor extends WorkActor {
    override def beat(tick: String): Unit = {
        ...
        ds.executeNonQuery(s"INSERT INTO qross_server_monitor (moment, cpu_usage, memory_usage, jvm_memory_usage, executing_tasks, running_actions) VALUES ('$tick', ${Environment.cpuUsage}, ${Environment.systemMemoryUsage}, ${Environment.jvmMemoryUsage}, $executingTasks, $runningActions)")
